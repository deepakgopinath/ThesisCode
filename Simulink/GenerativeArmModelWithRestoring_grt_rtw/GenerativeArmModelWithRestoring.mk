###########################################################################
## Makefile generated for Simulink model 'GenerativeArmModelWithRestoring'. 
## 
## Makefile     : GenerativeArmModelWithRestoring.mk
## Generated on : Mon Mar 16 10:19:43 2015
## MATLAB Coder version: 2.5 (R2013b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/GenerativeArmModelWithRestoring
...
PRODUCT_NAME              = GenerativeArmModelWithRestoring
MAKEFILE                  = GenerativeArmModelWithRestoring.mk
COMPUTER                  = MACI64
...
MODELREF_LINK_RSPFILE_NAME = GenerativeArmModelWithRestoring_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/GenerativeArmModelWithRestoring
...
INCLUDES_BUILDINFO = -I$(START_DIR)/GenerativeArmModelWithRestoring_grt_rtw -I$(START_DIR) -I$(START_DIR)/SampleCode -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(START_DIR)/slprj/grt/_sharedutils -I./referenced_model_includes
...
DEFINES_STANDARD = -DMODEL=GenerativeArmModelWithRestoring -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/GenerativeArmModelWithRestoring_grt_rtw/GenerativeArmModelWithRestoring.c $(START_DIR)/GenerativeArmModelWithRestoring_grt_rtw/GenerativeArmModelWithRestoring_data.c rt_logging.c
...
OBJS = GenerativeArmModelWithRestoring.o GenerativeArmModelWithRestoring_data.o rt_logging.o
...
MODELREF_LIBS = ../slprj/grt/ArmModelVersion2/ArmModelVersion2_rtwlib.a
...
%.o : $(START_DIR)/GenerativeArmModelWithRestoring_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/GenerativeArmModelWithRestoring_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
