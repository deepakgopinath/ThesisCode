  ...
  const mxArray * prhs[] )
{
  ...
  if (sf_MoreExperimentsWithGenerativeArmModelWithRestoring_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "MoreExperimentsWithGenerativeArmModelWithRestoring") ==
      0) {
...
extern void MoreExperimentsWithGenerativeArmModelWithRestoring_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    MoreExperimentsWithGenerativeArmModelWithRestoring_terminator();
...
extern void MoreExperimentsWithGenerativeArmModelWithRestoring_initializer(void);
extern void
  MoreExperimentsWithGenerativeArmModelWithRestoring_register_exported_symbols
  (SimStruct* S);
extern void MoreExperimentsWithGenerativeArmModelWithRestoring_debug_initialize(
    struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  MoreExperimentsWithGenerativeArmModelWithRestoring_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      MoreExperimentsWithGenerativeArmModelWithRestoring_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    MoreExperimentsWithGenerativeArmModelWithRestoring_initializer();
  }
